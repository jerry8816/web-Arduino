(() => {
  var e = {
        ...
        class i {
          ...
          async _connect(e, t) {
            (e = {
              ...
              this.port && (await this.close()),
              (this.port = t),
              await this.port.open(e),
              (this.reader = new n.ReadableWebToNodeStream(this.port.readable)),
              (this.writer = this.port.writable.getWriter());
            const r = this.reader;
            return (
              (r.write = (e, t) => (
                this.writer.write(e).then(() => t(null), t), !0
              )),
              r
            );
          }
      ...
      590: function (e, t, r) {
        ...
        const h = (e) => e();
        async function p(e, t, r, n = !1) {
          try {
            const i = await fetch(t)
                .then((e) => e.text())
                .then((e) => l.parse(e).data),
              o = await s.default.connect({ baudRate: e.baudRate });
            r(0);
            ...
            n && (p *= 2),
              (a.log = (e) => {
                if ("page done" === e || "verify done" === e) {
                  u += 1;
                  const e = Math.round((100 * u) / p);
                  r(e);
                }
              }),
              await f.default.series([
                a.sync.bind(a, o, 3, e.timeout),
                a.sync.bind(a, o, 3, e.timeout),
                a.sync.bind(a, o, 3, e.timeout),
                a.verifySignature.bind(a, o, e.signature, e.timeout),
                a.setOptions.bind(a, o, {}, e.timeout),
                a.enterProgrammingMode.bind(a, o, e.timeout),
                a.upload.bind(a, o, i, e.pageSize, e.timeout),
                n ? a.verify.bind(a, o, i, e.pageSize, e.timeout) : h,
                a.exitProgrammingMode.bind(a, o, e.timeout),
              ]);
          } finally {
            s.default.close();
          }
        }
        (t.upload = p), (t.default = p);
      },
      204: (e, t, r) => {
        "use strict";
        const n = r(590);
        document.addEventListener("DOMContentLoaded", () => {
          document.querySelectorAll("[arduino-uploader]").forEach((e) => {
            e.addEventListener("click", async () => {
              if (!navigator.serial)
                return alert(
                  "Please enable the Web Serial API first: https://web.dev/serial/#use"
                );
              ...
              try {
                await n.upload(n.boards[r], t, a, i);
              } catch (e) {
      ...
      664: (e, t, r) => {
        ...
        var a = "function" == typeof setImmediate && setImmediate,
          u = "object" == typeof n && "function" == typeof n.nextTick;
        function s(e) {
          setTimeout(e, 0);
        }
        function f(e) {
        ...
        var l = f(a ? setImmediate : u ? n.nextTick : s);
        function c(e) {
          return d(e)
            ? function (...t) {
                const r = t.pop();
        ...
        var R = (e) => (t, r, n) => {
            ...
            if (!t) return n(null);
            if ("AsyncGenerator" === t[Symbol.toStringTag])
              return E(t, e, r, n);
            if (
              (function (e) {
              ...
              return E(t[Symbol.asyncIterator](), e, r, n);
            var i = (function (e) {
                if (b(e))
                  return (function (e) {
                    var t = -1,
                ...
                return o
                  ...
                  : ((r = (t = e) ? Object.keys(t) : []),
                    ...
                    function () {
                      var e = r[++n];
                      return n < i ? { value: t[e], key: e } : null;
                    });
              })(t),
              o = !1,
              a = !1,
            ...
            function f(e, t) {
              if (!a)
                if (((u -= 1), e)) (o = !0), n(e);
                  ...
                  if (t === w || (o && u <= 0)) return (o = !0), n(null);
                  s || l();
                }
            }
            function l() {
              for (s = !0; u < e && !o; ) {
                var t = i();
                if (null === t) return (o = !0), void (u <= 0 && n(null));
                (u += 1), r(t.value, t.key, S(f));
              }
              s = !1;
            }
            l();
        ...
        function A(e, t, r) {
          ...
          function u(e, t) {
            !1 === e && (a = !0),
              !0 !== a && (e ? r(e) : (++i !== o && t !== w) || r(null));
          }
          for (0 === o && r(null); n < o; n++) t(e[n], n, S(u));
        }
        function k(e, t, r) {
          return T(e, 1 / 0, t, r);
        }
                ...
                if (
                  ((n = (function (e) {
                    ...
                    return n
                      .replace(/\s/g, "")
                      .split(U)
                      .map((e) => e.replace(q, "").trim());
                  })(i)),
                  0 === i.length && !o && 0 === n.length)
                )
                  throw new Error(
                    "autoInject task functions require explicit parameters."
                  );
                o || n.pop(), (r[t] = n.concat(u));
              }
              function u(e, t) {
                var r = n.map((t) => e[t]);
                r.push(t), y(i)(...r);
        ...
        function G(e, t, r) {
          ...
          function c(e, t, r, n) {
            ...
            v.started = !0;
            var u = { data: e, callback: r ? a : n || a };
            if (
              (t ? v._tasks.unshift(u) : v._tasks.push(u),
              f ||
                ((f = !0),
                l(() => {
                  (f = !1), v.process();
            ...
            return function (t, ...r) {
              ...
              for (var n = 0, a = e.length; n < a; n++) {
                ...
                0 === f ? o.shift() : f > 0 && o.splice(f, 1),
                  u.callback(t, ...r),
                  null != t && s("error", t, u.data);
              }
              i <= v.concurrency - v.buffer && s("unsaturated"),
                v.idle() && s("drain"),
                v.process();
            };
          }
          function p(e) {
            return !(0 !== e.length || !v.idle() || (l(() => s("drain")), 0));
          }
          const d = (e) => (t) => {
            if (!t)
              ...
              *[Symbol.iterator]() {
              ...
              process() {
                if (!g) {
                  for (
                    g = !0;
                    !v.paused && i < v.concurrency && v._tasks.length;
                    ...
                    for (var a = 0; a < r; a++) {
                      var u = v._tasks.shift();
                      e.push(u), o.push(u), t.push(u.data);
                    }
                    (i += 1),
                      0 === v._tasks.length && s("empty"),
                      i === v.concurrency && s("saturated");
                    var f = S(h(e));
                    n(t, f);
                  }
                  g = !1;
          ...
          return (
            Object.defineProperties(v, {
              saturated: { writable: !1, value: d("saturated") },
              unsaturated: { writable: !1, value: d("unsaturated") },
              empty: { writable: !1, value: d("empty") },
              drain: { writable: !1, value: d("drain") },
              error: { writable: !1, value: d("error") },
            }),
            v
          );
        }
            ...
            y(t)(...r, (t, ...r) => {
              "object" == typeof console &&
                (t
                  ...
                  : console[e] && r.forEach((t) => console[e](t)));
            });
        }
        var ue = ae("dir"),
          se = g(function (e, t, r) {
        ...
        function be(e, t, r, n) {
          ...
          e(
            ...
            (e) => {
              ...
              n(
                null,
                i.sort((e, t) => e.index - t.index).map((e) => e.value)
              );
            }
          );
        }
              ...
              a in r
                ...
                : ((n[a] = [o]),
                  i(...e, (e, ...t) => {
                    ...
                    var i = n[a];
                    delete n[a];
                    for (var o = 0, u = i.length; o < u; o++) i[o](e, ...t);
                  }));
            });
          return (a.memo = r), (a.unmemoized = e), a;
        }
        var je = f(u ? n.nextTick : a ? setImmediate : s),
          Pe = g((e, t, r) => {
            var n = b(t) ? [] : {};
            e(
              t,
          ...
          percDown(e) {
            ...
            for (
              ...
              (t + 1 < this.heap.length &&
                qe(this.heap[t + 1], this.heap[t]) &&
                (t += 1),
              !qe(this.heap[e], this.heap[t]));
          ...
          *[Symbol.iterator]() {
          ...
          remove(e) {
            ...
            for (let r = 0; r < this.heap.length; r++)
              e(this.heap[r]) || ((this.heap[t] = this.heap[r]), t++);
            this.heap.splice(t);
            for (let e = Ue(this.heap.length - 1); e >= 0; e--)
              this.percDown(e);
            return this;
          }
        }
          ...
          return (
            ...
            (r.push = function (e, t = 0, n = () => {}) {
              ...
              for (var i = 0, o = e.length; i < o; i++) {
                var a = { data: e[i], priority: t, callback: n };
                r._tasks.push(a);
              }
              l(r.process);
            }),
        ...
        function $e(e, t, r) {
          var n = { times: 5, intervalFunc: Xe(0) };
          if (
          ...
          function a() {
            i((e, ...t) => {
              !1 !== e &&
                (e &&
                o++ < n.times &&
                ("function" != typeof n.errorFilter || n.errorFilter(e))
                  ? setTimeout(a, n.intervalFunc(o - 1))
                  : r(e, ...t));
            });
          }
          return a(), r[P];
        ...
        function Ze(e, t) {
          ...
          return o((t, i) => {
            ...
            return (
              (t.length < r - 1 || null == i) && (t.push(i), (i = I())),
              e ? $e(e, o, i) : $e(o, i),
              i[P]
            );
          });
      ...
      764: (e, t, r) => {
        ...
        function c(e) {
          return l(e), u(e < 0 ? 0 : 0 | d(e));
        }
        function h(e) {
          for (
            var t = e.length < 0 ? 0 : 0 | d(e.length), r = u(t), n = 0;
            n < t;
            n += 1
          )
            r[n] = 255 & e[n];
        ...
        (t.kMaxLength = a),
          ...
          (s.compare = function (e, t) {
            if (
              (W(e, Uint8Array) && (e = s.from(e, e.offset, e.byteLength)),
              W(t, Uint8Array) && (t = s.from(t, t.offset, t.byteLength)),
          ...
          (s.concat = function (e, t) {
            ...
            for (r = 0; r < e.length; ++r) {
              var o = e[r];
              if ((W(o, Uint8Array) && (o = s.from(o)), !s.isBuffer(o)))
                throw new TypeError(
                  '"list" argument must be an Array of Buffers'
                );
        ...
        (s.prototype.slice = function (e, t) {
          ...
          (s.prototype.readFloatLE = function (e, t) {
            return (
              (e >>>= 0), t || j(e, 4, this.length), i.read(this, e, !0, 23, 4)
            );
          }),
          (s.prototype.readFloatBE = function (e, t) {
            return (
              (e >>>= 0), t || j(e, 4, this.length), i.read(this, e, !1, 23, 4)
            );
          }),
          (s.prototype.readDoubleLE = function (e, t) {
            return (
              (e >>>= 0), t || j(e, 8, this.length), i.read(this, e, !0, 52, 8)
            );
          }),
          (s.prototype.readDoubleBE = function (e, t) {
            return (
              (e >>>= 0), t || j(e, 8, this.length), i.read(this, e, !1, 52, 8)
            );
          }),
              ...
              t = Math.abs(t),
                isNaN(t) || t === 1 / 0
                  ...
                  : ((a = Math.floor(Math.log(t) / Math.LN2)),
                    ...
                    (t += a + c >= 1 ? h / s : h * Math.pow(2, 1 - c)) * s >=
                      2 && (a++, (s /= 2)),
                    a + c >= l
                      ? ((u = 0), (a = l))
                      : a + c >= 1
                      ? ((u = (t * s - 1) * Math.pow(2, i)), (a += c))
                      : ((u = t * Math.pow(2, c - 1) * Math.pow(2, i)),
                        (a = 0)));
              i >= 8;
              e[r + p] = 255 & u, p += d, u /= 256, i -= 8
            );
            for (
              a = (a << i) | u, f += i;
              f > 0;
              e[r + p] = 255 & a, p += d, a /= 256, f -= 8
            );
            e[r + p - d] |= 128 * y;
          });
      },
      ...
      620: (e, t, r) => {
        ...
        t.parse = function (e, t) {
          ...
          for (
            ...
            if (":" != e.charAt(f++))
              throw new Error(
                "Line " + (s + 1) + " does not start with a colon (:)."
              );
            s++;
            ...
            f += 2;
            for (var g = (l + (c >> 8) + c + h) & 255, v = 0; v < l; v++)
              g = (g + d[v]) & 255;
            if (y != (g = (256 - g) & 255))
              throw new Error(
            ...
            switch (h) {
              ...
              case 1:
                if (0 != l)
                  throw new Error("Invalid EOF record on line " + s + ".");
                return {
                  data: r.slice(0, i),
                  startSegmentAddress: a,
                  startLinearAddress: u,
                };
              case 2:
                if (2 != l || 0 != c)
                  throw new Error(
                    "Invalid extended segment address record on line " + s + "."
                  );
                o = parseInt(p, 16) << 4;
                break;
              case 3:
                if (4 != l || 0 != c)
                  throw new Error(
                    "Invalid start segment address record on line " + s + "."
                  );
                a = parseInt(p, 16);
                break;
              case 4:
                if (2 != l || 0 != c)
                  throw new Error(
                    "Invalid extended linear address record on line " + s + "."
                  );
                o = parseInt(p, 16) << 16;
                break;
              case 5:
                if (4 != l || 0 != c)
                  throw new Error(
                    "Invalid start linear address record on line " + s + "."
                  );
                u = parseInt(p, 16);
                break;
              default:
                throw new Error("Invalid record type (" + h + ") on line " + s);
            }
            "\r" == e.charAt(f) && f++, "\n" == e.charAt(f) && f++;
          }
          throw new Error(
      ...
      155: (e) => {
        ...
        (n.nextTick = function (e) {
          ...
          s.push(new p(e, t)), 1 !== s.length || f || a(h);
        }),
          ...
          r(
            ...
            function (e, t, r) {
              ...
              if (
                ...
                var f =
                  ("number" != typeof s && (s = 0),
                  s + ".".length > (u = e).length || -1 === u.indexOf(".", s)
                    ? "argument"
                    : "property");
                a = 'The "'
                  .concat(e, '" ')
      ...
      481: (e, t, r) => {
        ...
        function A(e, t, r, n, i) {
          ...
          if (null === t)
            ...
            if (
              ...
              u.endEmitted ? S(e, new _()) : k(e, u, t, !0);
            else if (u.ended) S(e, new b());
            else {
              if (u.destroyed) return !1;
              (u.reading = !1),
                u.decoder && !r
                  ? ((t = u.decoder.write(t)),
                    u.objectMode || 0 !== t.length ? k(e, u, t, !1) : C(e, u))
                  : k(e, u, t, !1);
            }
          else n || ((u.reading = !1), C(e, u));
        ...
        (T.prototype.read = function (e) {
          ...
          (T.prototype.pipe = function (e, t) {
            ...
            var u =
              (t && !1 === t.end) || e === i.stdout || e === i.stderr ? y : s;
            function s() {
              o("onend"), e.end();
            }
            n.endEmitted ? i.nextTick(u) : r.once("end", u),
              ...
              "data" === e
                ...
                : "readable" === e &&
                  (n.endEmitted ||
                    ...
                    n.length ? x(this) : n.reading || i.nextTick(I, this))),
              r
            );
          }),
              ...
              !(function (e, t) {
                ...
                if (
                  ...
                  a ||
                    ...
                    !r.bufferedRequest ||
                    L(e, r),
                    n ? i.nextTick(k, e, r, a, o) : k(e, r, a, o);
                }
              })(t, e);
            }),
            (this.writecb = null),
          ...
          if (e._writev && r && r.next) {
            ...
            for (; r; ) {
              var f = r.chunk,
                ...
                c = r.callback;
              if (
                (A(e, t, !1, t.objectMode ? 1 : f.length, f, l, c),
                (r = r.next),
            ...
            ((function (e, t) {
              t.prefinished ||
                ...
                ("function" != typeof e._final || t.destroyed
                  ...
                  : (t.pendingcb++, (t.finalCalled = !0), i.nextTick(x, e, t)));
            })(e, t),
            0 === t.pendingcb &&
        ...
        r(717)(T, s),
            ...
            ? ((a = Function.prototype[Symbol.hasInstance]),
              Object.defineProperty(T, Symbol.hasInstance, {
                value: function (e) {
                  return (
                    !!a.call(this, e) ||
                    (this === T && e && e._writableState instanceof R)
                  );
                },
              }))
            : (a = function (e) {
          ...
          (T.prototype.write = function (e, t, r) {
            var n,
              ...
              a = !1,
              u = !o.objectMode && ((n = e), f.isBuffer(n) || n instanceof l);
            return (
              u &&
                !f.isBuffer(e) &&
                (e = (function (e) {
          ...
          (T.prototype.destroy = c.destroy),
          (T.prototype._undestroy = c.undestroy),
          (T.prototype._destroy = function (e, t) {
            t(e);
          });
      },
        ...
        e.exports = function (e) {
            ...
            r = Object.create(
              ...
              o(t, h, {
                value: function (e, t) {
                  var n = r[p].read();
                  n
                    ? ((r[c] = null), (r[u] = null), (r[s] = null), e(d(n, !1)))
                    : ((r[u] = e), (r[s] = t));
                },
                writable: !0,
              }),
          ...
          return (
            ...
            a(e, function (e) {
              ...
              var n = r[u];
              null !== n &&
                ((r[c] = null), (r[u] = null), (r[s] = null), n(d(void 0, !0))),
                (r[l] = !0);
            }),
          ...
          async _read() {
            ...
            delete this.pendingRead,
              e.done || this.released
                ? this.push(null)
                : ((this.bytesRead += e.value.length), this.push(e.value));
          }
      ...
      107: (e, t, r) => {
        ...
        (u.prototype.sync = function (e, t, r, n) {
          this.log("sync");
          var i = this,
            u = 1,
            s = {
          ...
          !(function r() {
            (u += 1),
              a(e, s, function (e, o) {
                if (e && u <= t)
                  return e && i.log(e), i.log("failed attempt again", u), r();
                i.log("sync complete", e, o, u), n(e, o);
              });
          })();
        }),
          (u.prototype.verifySignature = function (e, t, r, i) {
            this.log("verify signature");
            var u = this;
            match = n.concat([
              n.from([o.Resp_STK_INSYNC]),
              t,
              n.from([o.Resp_STK_OK]),
            ]);
            var s = {
            ...
            a(e, s, function (e, t) {
              t
                ? u.log("confirm signature", e, t, t.toString("hex"))
                : u.log("confirm signature", e, "no data"),
                i(e, t);
            });
          }),
          (u.prototype.getSignature = function (e, t, r) {
          ...
          (u.prototype.setOptions = function (e, t, r, n) {
            this.log("set device");
            var i = this,
              u = {
                cmd: [
                  o.Cmnd_STK_SET_DEVICE,
                  t.devicecode || 0,
                  t.revision || 0,
                  t.progtype || 0,
                  t.parmode || 0,
          ...
          (u.prototype.enterProgrammingMode = function (e, t, r) {
          ...
          (u.prototype.loadAddress = function (e, t, r, n) {
            this.log("load address");
            var i = this,
              u = 255 & t,
              s = (t >> 8) & 255,
              f = {
                cmd: [o.Cmnd_STK_LOAD_ADDRESS, u, s],
                responseData: o.OK_RESPONSE,
                timeout: r,
              };
            a(e, f, function (e, t) {
          ...
          (u.prototype.loadPage = function (e, t, r, i) {
            this.log("load page");
            var u = this,
              s = 255 & t.length,
              f = t.length >> 8,
              l = {
                cmd: n.concat([
                  n.from([o.Cmnd_STK_PROG_PAGE, f, s, 70]),
                  t,
                  n.from([o.Sync_CRC_EOP]),
                ]),
                responseData: o.OK_RESPONSE,
                timeout: r,
              };
            a(e, l, function (e, t) {
              u.log("loaded page", e, t), i(e, t);
            });
          }),
          (u.prototype.upload = function (e, t, r, n, o) {
            this.log("program");
            var a,
              u,
              s = 0,
            ...
            i.whilst(
                ...
                f.log("program page"),
                  i.series(
                    [
                      ...
                      function (t) {
                        f.loadAddress(e, u, n, t);
                      },
                      function (e) {
                        (a = t.slice(s, t.length > r ? s + r : t.length - 1)),
                          e();
                      },
                      function (t) {
                        f.loadPage(e, a, n, t);
              ...
              function (e) {
                f.log("upload done"), o(e);
              }
            );
          }),
          (u.prototype.exitProgrammingMode = function (e, t, r) {
          ...
          (u.prototype.verify = function (e, t, r, n, o) {
            this.log("verify");
            var a,
              u,
              s = 0,
          ...
          (u.prototype.verifyPage = function (e, t, r, i, u) {
            ...
            a(e, l, function (e, t) {
              s.log("confirm page", e, t, t.toString("hex")), u(e, t);
            });
          }),
          (u.prototype.bootload = function (e, t, r, n) {
            var o = {
            ...
            i.series(
              [
                this.sync.bind(this, e, 3, r.timeout),
                this.sync.bind(this, e, 3, r.timeout),
                this.sync.bind(this, e, 3, r.timeout),
                this.verifySignature.bind(this, e, r.signature, r.timeout),
                this.setOptions.bind(this, e, o, r.timeout),
                this.enterProgrammingMode.bind(this, e, r.timeout),
                this.upload.bind(this, e, t, r.pageSize, r.timeout),
                this.verify.bind(this, e, t, r.pageSize, r.timeout),
                this.exitProgrammingMode.bind(this, e, r.timeout),
              ],
              function (e) {
                return n(e);
              }
      ...
      310: (e, t, r) => {
        ...
        e.exports = function (e, t, r, o) {
          var a = n.alloc(0),
            ...
            s = null,
            f = function (e) {
              for (var t = 0; !u && t < e.length; ) {
                var o = e[t];
                -1 !== i.indexOf(o) &&
                  ((e = e.slice(t, e.length - t)), (u = !0)),
                  t++;
              }
              if ((u && (a = n.concat([a, e])), a.length > r))
                return l(new Error("buffer overflow " + a.length + " > " + r));
              a.length == r && l();
            },
            l = function (t) {
              s && clearTimeout(s), e.removeListener("data", f), o(t, a);
            };
          t &&
            t > 0 &&
            (s = setTimeout(function () {
              (s = null), l(new Error("receiveData timeout after " + t + "ms"));
            }, t)),
            e.on("data", f);
        };
      },
      270: (e, t, r) => {
        ...
        e.exports = function (e, t, r) {
          var a,
            u = t.timeout || 0,
            s = (o.Resp_STK_INSYNC, o.Resp_STK_NOSYNC, null),
            f = 0;
          t.responseData && t.responseData.length > 0 && (s = t.responseData),
            s && (f = s.length),
            t.responseLength && (f = t.responseLength);
          var l = t.cmd;
          l instanceof Array && (l = n.from(l.concat(o.Sync_CRC_EOP))),
            e.write(l, function (t) {
              if (t)
                return (
                  (a = new Error(
                    "Sending " + l.toString("hex") + ": " + t.message
                  )),
                  r(a)
                );
              i(e, u, f, function (e, t) {
                return e
                  ? ((a = new Error(
                      "Sending " + l.toString("hex") + ": " + e.message
                    )),
                    r(a))
                  : s && !t.equals(s)
                  ? ((a = new Error(
      ...
      668: (e, t, r) => {
        ...
        !(function () {
          ...
          void 0 !== i && i.nextTick
            ...
            (a.eachLimit = function (e, t, r, n) {
              p(t).apply(null, [e, r, n]);
            }),
            (a.forEachLimit = a.eachLimit);
          var p = function (e) {
              return function (t, r, n) {
                if (((n = n || function () {}), !t.length || e <= 0))
                  return n();
                var i = 0,
                  o = 0,
                  a = 0;
                !(function u() {
                  ...
                  for (; a < e && o < t.length; )
                    (a += 1),
                      r(t[(o += 1) - 1], function (e) {
                        e
                          ? (n(e), (n = function () {}))
                          : ((a -= 1), (i += 1) >= t.length ? n() : u());
                      });
                })();
              };
            },
          ...
          (a.reduce = function (e, t, r, n) {
            ...
            (a.inject = a.reduce),
            (a.foldl = a.reduce),
            (a.reduceRight = function (e, t, r, n) {
          ...
          (a.detect = d(w)),
            ...
            (a.sortBy = function (e, t, r) {
              a.map(
                ...
                function (e, r) {
                  t(e, function (t, n) {
                    t ? r(t) : r(null, { value: e, criteria: n });
                  });
                },
                function (e, t) {
                  if (e) return r(e);
            ...
            (a.queue = function (e, t) {
              function r(e, t, r, n) {
                ...
                l(t, function (t) {
                  ...
                  r ? e.tasks.unshift(i) : e.tasks.push(i),
                    e.saturated &&
                    ...
                    if (!i.paused && n < i.concurrency && i.tasks.length) {
                      ...
                      var r = u(function () {
                        (n -= 1),
                          ...
                          i.drain && i.tasks.length + n === 0 && i.drain(),
                          i.process();
                      });
                      e(t.data, r);
                    }
                    ...
                    f(e) || (e = [e]),
                      l(e, function (e) {
                        n.push({
                          ...
                          (i.drained = !1),
                          i.saturated && n.length === t && i.saturated();
                      }),
                      a.setImmediate(i.process);
                  },
                  process: function o() {
